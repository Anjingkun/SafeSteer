...
class ModelBase(ABC):
    def __init__(self, ori_model: AutoModelForCausalLM, ori_tokenier: AutoTokenizer):
        self.model: AutoModelForCausalLM = ori_model
        self.tokenizer: AutoTokenizer = ori_tokenier
